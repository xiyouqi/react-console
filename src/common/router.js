...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/assess': {
      component: dynamicWrapper(app, ['list'], () => import('../routes/Assess/AssessList')),
    },
    '/projects': {
      component: dynamicWrapper(app, ['list'], () => import('../routes/Project/Projects')),
    },
    '/projects/list': {
      component: dynamicWrapper(app, ['list'], () => import('../routes/Project/ProjectList')),
    },
    '/projects/:id': {
      component: dynamicWrapper(app, ['rule'], () => import('../routes/Project/ProjectProfile')),
    },
    '/projects/:id/info': {
      component: dynamicWrapper(app, ['profile'], () => import('../routes/Project/ProjectInfo')),
    },
    '/projects/:id/docs': {
      component: dynamicWrapper(app, ['list'], () => import('../routes/Project/ProjectDocs')),
    },
