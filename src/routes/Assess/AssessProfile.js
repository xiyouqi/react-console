...
const description = (
  <DescriptionList className={styles.headerList} size="small" col="3">
    <Description term="项目经理">林河</Description>
    <Description term="项目阶段">设计</Description>
    <Description term="创建时间">2017-07-07</Description>
    <Description term="合同金额">¥ 50.08 万元</Description>
...
export default class ProjectProfile extends PureComponent {
  ...
  handleTabChange = key => {
    ...
    switch (key) {
      ...
      case 'cost':
        ...
        break;
      case 'supplies':
        dispatch(routerRedux.push(`${match.url}/supplies`));
        break;
      case 'q':
        dispatch(routerRedux.push(`${match.url}/q`));
        break;
      case 'report':
  ...
  render() {
    ...
    return (
      <PageHeaderLayout
        title="社会管理综合治理接入项目"
        logo={<img alt="" src="../src/assets/communication-network.png" />}
        action={action}
        content={description}
        extraContent={extra}
        tabList={tabList}
