...
export function fakeList(count) {
  ...
  for (let i = 0; i < count; i += 1) {
    list.push({
      ...
      cost_name: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][1],
      cost_format: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][2],
      cost_unit: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][3],
      cost_no_tax_price: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][4],
      cost_tax: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][5],
      cost_price: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][6],
      cost_num: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][7],
      cost_no_tax_amount: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][8],
      cost_tax_amount: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][9],
      cost_amount: projectData['国内器材概算表(表四)甲 主要材料表'][i % 5 + 1][10],
      ...
      kpi_code: projectData['家客类指标'][i % 14 + 1][0],
      kpi_level1: projectData['家客类指标'][i % 14 + 1][1],
      kpi_level2: projectData['家客类指标'][i % 14 + 1][2],
      kpi_level3: projectData['家客类指标'][i % 14 + 1][3],
      kpi_caption: projectData['家客类指标'][i % 14 + 1][4],
      type: types[i % 8],
      avatar: avatars[i % 8],
